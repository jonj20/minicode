...
export interface MemoryConfig {
	...
	/** Override extension storage directory. Default: ~/.minicode/agent/pi-hermes-memory */
	memoryDir?: string;
	/** Directory for project-scoped memory (relative to ~/.minicode/agent). Default: "projects-memory" */
