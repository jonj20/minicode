 ...
 *
 * Global skills live in ~/.minicode/agent/pi-hermes-memory/skills/<slug>/SKILL.md.
 * Project skills live in ~/.minicode/agent/<projectsMemoryDir>/<project>/skills/<slug>/SKILL.md.
 */
