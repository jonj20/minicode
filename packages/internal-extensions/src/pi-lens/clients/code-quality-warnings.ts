...
export function recordFromCodeQualityDiagnostic(
	...
	if (diagnostic.fixable || diagnostic.fixSuggestion || diagnostic.autoFixAvailable) return undefined;
...
export function appendCodeQualityWarningsHistory(cwd: string, report: CodeQualityWarningsReport): void {
...
export function formatCodeQualityWarningsAdvisory(report: CodeQualityWarningsReport): string | undefined {
