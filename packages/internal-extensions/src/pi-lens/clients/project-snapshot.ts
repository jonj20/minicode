...
import { deserializeWordIndex, type SerializedWordIndex, serializeWordIndex } from "./word-index.js";
...
export function hydrateRuntimeFromProjectSnapshot(runtime: RuntimeCoordinator, snapshot: ProjectSnapshot): void {
