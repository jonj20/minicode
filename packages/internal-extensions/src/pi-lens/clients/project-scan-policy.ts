...
import { getProjectIgnoreMatcher, isExcludedDirName, type ProjectIgnoreMatcher } from "./file-utils.js";
import { isGeneratedArtifactDirectoryName, isGeneratedOrArtifact } from "./generated-artifacts.js";
import { collectSourceFiles, collectSourceFilesAsync, type SourceCollectionOptions } from "./source-filter.js";
...
export interface ProjectSourceFilePolicyOptions extends Omit<ProjectPathPolicyOptions, "isDirectory"> {}

export interface ProjectSourceCollectionOptions extends SourceCollectionOptions {}

export function shouldSkipProjectPath(filePath: string, options: ProjectPathPolicyOptions): boolean {
...
export function shouldScanProjectSourceFile(filePath: string, options: ProjectSourceFilePolicyOptions): boolean {
	try {
...
export function collectProjectSourceFiles(rootDir: string, options?: ProjectSourceCollectionOptions): string[] {
