...
export function withDeadline<T>(promise: Promise<T>, options: DeadlineOptions): Promise<T | undefined>;
export function withDeadline<T>(promise: Promise<T>, options: DeadlineOptions): Promise<T | undefined> {
	...
	const base: Promise<T | undefined> = onReject === "undefined" ? promise.catch(() => undefined) : promise;
 ...
 */
export function withinRemaining<T>(promise: Promise<T>, deadlineAt: number): Promise<T | undefined> {
