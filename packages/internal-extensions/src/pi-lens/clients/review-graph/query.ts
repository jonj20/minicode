...
import type { ImpactCascadeResult, ReviewGraph, ReviewGraphEdge, ReviewGraphEdgeKind } from "./types.js";
...
function collectIncomingEdges(graph: ReviewGraph, nodeIds: string[], kind: ReviewGraphEdge["kind"]): ReviewGraphEdge[] {
