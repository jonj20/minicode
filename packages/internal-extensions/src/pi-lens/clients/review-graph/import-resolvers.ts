...
function findGoModule(cwd: string, filePath: string): { moduleDir: string; modulePath: string } | null {
 ...
 */
export function resolveImportToFiles(cwd: string, filePath: string, languageId: string, source: string): string[] {
	switch (languageId) {
		case "typescript":
		case "tsx":
		case "javascript":
