...
import type { GovulncheckFinding, GovulncheckResult } from "../../govulncheck-client.js";
 ...
 */
export function govulncheckFindingToProjectDiagnostic(cwd: string, finding: GovulncheckFinding): ProjectDiagnostic {
...
export function govulncheckResultToProjectDiagnostics(cwd: string, result: GovulncheckResult): ProjectDiagnostic[] {
