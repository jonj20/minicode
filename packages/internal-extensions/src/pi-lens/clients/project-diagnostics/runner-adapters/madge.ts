 ...
 */
export function circularDepToProjectDiagnostics(cwd: string, dep: CircularDep): ProjectDiagnostic[] {
 ...
 */
export function circularDepsToProjectDiagnostics(cwd: string, circular: CircularDep[]): ProjectDiagnostic[] {
