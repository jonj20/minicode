 ...
 */
export function trivyFindingToProjectDiagnostic(cwd: string, finding: TrivyFinding): ProjectDiagnostic {
...
export function trivyResultToProjectDiagnostics(cwd: string, result: TrivyResult): ProjectDiagnostic[] {
