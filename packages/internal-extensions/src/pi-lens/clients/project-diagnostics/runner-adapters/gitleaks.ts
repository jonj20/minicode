 ...
 */
export function gitleaksFindingToProjectDiagnostic(cwd: string, finding: GitleaksFinding): ProjectDiagnostic {
	return {
		filePath: path.isAbsolute(finding.file) ? finding.file : path.resolve(cwd, finding.file),
...
export function gitleaksResultToProjectDiagnostics(cwd: string, result: GitleaksResult): ProjectDiagnostic[] {
