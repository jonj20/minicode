...
export function sessionStartMode(reason: string | undefined, hasPendingForkSnapshot: boolean): SessionStartMode {
 ...
 */
export async function dropStaleFiles(widget: PersistedWidgetState, savedAt: number): Promise<PersistedWidgetState> {
