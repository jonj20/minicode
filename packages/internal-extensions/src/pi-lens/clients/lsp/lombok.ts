...
export function resolveLombokJar(root: string, env: NodeJS.ProcessEnv = process.env): string | undefined {
...
function resolveLombokJavaAgentArg(root: string, baseEnv: NodeJS.ProcessEnv = process.env): string | undefined {
...
export function createLombokJdtlsArgs(root: string, baseEnv: NodeJS.ProcessEnv = process.env): string[] {
