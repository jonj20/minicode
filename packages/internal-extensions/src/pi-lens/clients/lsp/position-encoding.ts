...
export function negotiatePositionEncoding(serverCapabilities: unknown): PositionEncoding {
	const raw = (serverCapabilities as { positionEncoding?: unknown } | null | undefined)?.positionEncoding;
 ...
 */
export function convertCharacterOffset(encoding: PositionEncoding, lineText: string, utf16Character: number): number {
