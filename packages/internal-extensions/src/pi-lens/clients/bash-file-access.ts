...
function collectGrepCommandFiles(command: string, cwd: string): { hasLineNumberGrep: boolean; files: Set<string> } {
...
function dedupePushSearchRead(out: SearchReadLocation[], seen: Set<string>, loc: SearchReadLocation | undefined): void {
	if (!loc) return;
...
function parseGrepOutputSearchReads(output: string, cwd: string, singleFile?: string): SearchReadLocation[] {
 ...
 */
export function extractGrepSearchReadsFromOutput(command: string, cwd: string, output: string): SearchReadLocation[] {
