 ...
 */
export function findNearestContaining(startDir: string, candidates: readonly string[]): string | undefined {
...
const VENDOR_DIR_NAMES = new Set(["node_modules", "vendor", "vendors", "third_party", "third-party"]);
