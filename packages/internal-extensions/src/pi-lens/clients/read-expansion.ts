...
const ENCLOSING_TYPES: Record<string, string[]> = {
	...
	tsx: ["function_declaration", "function_expression", "arrow_function", "method_definition", "class_declaration"],
	javascript: [
		"function_declaration",
		"function_expression",
		"arrow_function",
...
function findEnclosingNodeForRange(node: any, startRow: number, endRow: number, types: string[]): any {
