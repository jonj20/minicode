...
let psCmd: string | null | undefined;
let psAnalyzerAvailable: boolean | undefined;
...
const psScriptAnalyzerRunner: RunnerDefinition = {
	...
	async run(ctx: DispatchContext): Promise<RunnerResult> {
		...
		try {
			const result = await spawnPs(cmd, ["-NoProfile", "-NonInteractive", "-File", tmpScript, "-FilePath", absPath]);
