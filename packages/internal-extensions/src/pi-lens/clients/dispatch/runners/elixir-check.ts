...
function parseElixirOutput(raw: string, filePath: string, cwd: string = process.cwd()): Diagnostic[] {
					...
					diagnostics: [
						{
							...
							message: firstOutputLine(result) || `${command} exited non-zero without structured diagnostics`,
