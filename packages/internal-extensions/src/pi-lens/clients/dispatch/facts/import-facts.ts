...
import { childrenOfType, firstChildOfType, parseFactTree, type TsNode, walk } from "./tree-sitter-facts.js";
...
const JSTS_EXTS = new Set([".ts", ".tsx", ".mts", ".cts", ".js", ".jsx", ".mjs", ".cjs"]);
...
function parseStaticImport(node: TsNode, moduleType: "esm" | "cjs" | "unknown"): ImportEntry | null {
