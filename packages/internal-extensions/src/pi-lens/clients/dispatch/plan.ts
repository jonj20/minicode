...
export const LANGUAGE_CAPABILITY_MATRIX: Record<FileKind, CapabilityMatrixEntry> = {
	...
	cxx: {
		name: "C/C++ Linting",
		capabilities: ["types", "lint", "smells"],
		writeGroups: [primary("cxx"), { mode: "all", runnerIds: ["tree-sitter"], filterKinds: ["cxx"] }],
	},
	cmake: {
		name: "CMake Processing",
		capabilities: ["lint"],
		writeGroups: [primary("cmake"), { mode: "all", runnerIds: ["fact-rules"], filterKinds: ["cmake"] }],
	},
	fish: {
	...
	markdown: {
		...
		writeGroups: [primary("markdown"), { mode: "all", runnerIds: ["markdownlint"], filterKinds: ["markdown"] }],
	},
	css: {
		name: "CSS Processing",
		capabilities: ["format", "lint"],
	...
	yaml: {
		...
		capabilities: ["format", "lint"],
		writeGroups: [primary("yaml"), { mode: "all", runnerIds: ["actionlint"], filterKinds: ["yaml"] }],
	},
	sql: {
		name: "SQL Processing",
		capabilities: ["format", "lint"],
	...
	kotlin: {
		...
		writeGroups: [primary("kotlin"), { mode: "fallback", runnerIds: ["detekt"], filterKinds: ["kotlin"] }],
	},
	swift: {
		name: "Swift Linting",
		capabilities: ["types", "lint"],
