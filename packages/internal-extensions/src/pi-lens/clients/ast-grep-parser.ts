...
export class AstGrepParser {
	...
	private parseNewFormat(item: AstGrepJsonDiagnostic, filterFile: string): AstGrepDiagnostic | null {
	...
	private parseLegacyFormat(item: AstGrepJsonDiagnostic, filterFile: string): AstGrepDiagnostic | null {
