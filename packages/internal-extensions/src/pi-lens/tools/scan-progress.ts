...
export type ToolUpdate = (update: { content: Array<{ type: "text"; text: string }>; details?: unknown }) => void;
...
export function renderScanProgress(completed: number, total: number, label = "Scanning project diagnostics"): string {
