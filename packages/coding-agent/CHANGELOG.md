...
- Fixed truncated responses to compact and retry once when output stops below the model's desired output limit, instead of surfacing the output-token-limit error immediately.
